...
import com.huangxue.s01.Beans.RecruitListBean;
...
public class CityAnalyseActivity extends AppCompatActivity {
    ...
    private List<RecruitListBean.RowsEntity> jobRows;
    ...
    private void initHttp(){
        ...
        jobRows = gson.fromJson(jobBody, RecruitListBean.class).getRows();
...
//        xAxis.setAxisMinimum(0);
    ...
    private void initPieChart() {
        ...
        //循环数据集合
        for (RecruitListBean.RowsEntity data : jobRows) {
