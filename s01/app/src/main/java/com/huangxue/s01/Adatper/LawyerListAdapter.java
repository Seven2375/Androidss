...
public class LawyerListAdapter extends RecyclerView.Adapter<LawyerListAdapter.MyHolder> {

    private List<LawyerListBean.RowsEntity> dataList;
    private Context mContext;

    public LawyerListAdapter(List<LawyerListBean.RowsEntity> dataList, Context mContext) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        LawyerListBean.RowsEntity data = dataList.get(position);
